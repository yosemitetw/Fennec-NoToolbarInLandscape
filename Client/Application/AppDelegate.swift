...
class AppDelegate: UIResponder, UIApplicationDelegate, UIViewControllerRestoration {
    ...
    @discardableResult fileprivate func startApplication(_ application: UIApplication, withLaunchOptions launchOptions: [AnyHashable: Any]?) -> Bool {
        ...
        // Detect Orientation Change Event !!
         NotificationCenter.default.addObserver( self, selector: #selector( AppDelegate.rotated ), name: NSNotification.Name.UIDeviceOrientationDidChange, object: nil )
     //   NotificationCenter.default.addObserver( self, selector: #selector( browserViewController.changeOrientation ), name: NSNotification.Name.UIDeviceOrientationDidChange, object: nil )
    ...
    func rotated() {
        browserViewController.changeOrientation()
    }
