...
enum AppMenuAction: String {
    ...
    // New Action: 
    case reloadAuth = "ReloadAuth"
    // This is referenced as AppMenuAction.reloadAuth.rawValue = "ReloadAuth"
}
...
struct AppMenuConfiguration: MenuConfiguration {
    ...
    fileprivate func menuItemsForAppState(_ appState: AppState) -> [MenuItem] {
        ...
        case .tab(let tabState):
            ...
            // NEW Menu ITEM
            menuItems.append( AppMenuConfiguration.ReloadAuthMenuItem )
        case .homePanels:
            menuItems.append(AppMenuConfiguration.NewTabMenuItem)
            menuItems.append(AppMenuConfiguration.NewPrivateTabMenuItem)
...
extension AppMenuConfiguration {
    ...
    fileprivate static var ReloadAuthMenuItem: MenuItem {
        return AppMenuItem( title:MenuButtonReloadAuthString, accessibilityIdentifier: "ReloadAuthMenuItem", action: MenuAction( action: AppMenuAction.reloadAuth.rawValue ), icon: "menu-RequestDesktopSite", privateModeIcon: "menu-RequestDesktopSite-pbm")
    }
...
//    static let NewTabTitleString = NSLocalizedString("Menu.NewTabAction.Title", tableName: "Menu", value: "New Tab", comment: "Label for the button, displayed in the menu, used to open a new tab")
    static let NewTabTitleString = NSLocalizedString("Menu.NewTabAction.Title", tableName: "Menu", value: "新网页", comment: "Label for the button, displayed in the menu, used to open a new tab")
    static let NewPrivateTabTitleString = NSLocalizedString("Menu.NewPrivateTabAction.Title", tableName: "Menu", value: "新私有分页", comment: "Label for the button, displayed in the menu, used to open a new private tab.")
    static let AddBookmarkTitleString = NSLocalizedString("Menu.AddBookmarkAction.Title", tableName: "Menu", value: "加书签", comment: "Label for the button, displayed in the menu, used to create a bookmark for the current website.")
    static let RemoveBookmarkTitleString = NSLocalizedString("Menu.RemoveBookmarkAction.Title", tableName: "Menu", value: "移除书签", comment: "Label for the button, displayed in the menu, used to delete an existing bookmark for the current website.")
    static let FindInPageTitleString = NSLocalizedString("Menu.FindInPageAction.Title", tableName: "Menu", value: "於此頁找尋", comment: "Label for the button, displayed in the menu, used to open the toolbar to search for text within the current page.")
    static let ViewDesktopSiteTitleString = NSLocalizedString("Menu.ViewDekstopSiteAction.Title", tableName: "Menu", value: "要求桌面版网页", comment: "Label for the button, displayed in the menu, used to request the desktop version of the current website.")
    static let ViewMobileSiteTitleString = NSLocalizedString("Menu.ViewMobileSiteAction.Title", tableName: "Menu", value: "要求行动版网页", comment: "Label for the button, displayed in the menu, used to request the mobile version of the current website.")
   // static let SettingsTitleString = NSLocalizedString("Menu.OpenSettingsAction.Title", tableName: "Menu", value: "Settings", comment: "Label for the button, displayed in the menu, used to open the Settings menu.")
    static let SettingsTitleString = NSLocalizedString("Menu.OpenSettingsAction.Title", tableName: "Menu", value: "设置", comment: "Label for the button, displayed in the menu, used to open the Settings menu.")
//    static let CloseAllTabsTitleString = NSLocalizedString("Menu.CloseAllTabsAction.Title", tableName: "Menu", value: "Close All Tabs", comment: "Label for the button, displayed in the menu, used to close all tabs currently open.")
    static let CloseAllTabsTitleString = NSLocalizedString("Menu.CloseAllTabsAction.Title", tableName: "Menu", value: "关闭所有分页", comment: "Label for the button, displayed in the menu, used to close all tabs currently open.")
//    static let OpenHomePageTitleString = NSLocalizedString("Menu.OpenHomePageAction.Title", tableName: "Menu", value: "Home", comment: "Label for the button, displayed in the menu, used to navigate to the home page.")
    static let OpenHomePageTitleString = NSLocalizedString("Menu.OpenHomePageAction.Title", tableName: "Menu", value: "家", comment: "Label for the button, displayed in the menu, used to navigate to the home page.")
//    static let SetHomePageTitleString = NSLocalizedString("Menu.SetHomePageAction.Title", tableName: "Menu", value: "Set Homepage", comment: "Label for the button, displayed in the menu, used to set the homepage if none is currently set.")
    static let SetHomePageTitleString = NSLocalizedString("Menu.SetHomePageAction.Title", tableName: "Menu", value: "设置成首页", comment: "Label for the button, displayed in the menu, used to set the homepage if none is currently set.")
//    static let SharePageTitleString = NSLocalizedString("Menu.SendPageAction.Title", tableName: "Menu", value: "Send", comment: "Label for the button, displayed in the menu, used to open the share dialog.")
    static let SharePageTitleString = NSLocalizedString("Menu.SendPageAction.Title", tableName: "Menu", value: "传送", comment: "Label for the button, displayed in the menu, used to open the share dialog.")
//    static let TopSitesTitleString = NSLocalizedString("Menu.OpenTopSitesAction.AccessibilityLabel", tableName: "Menu", value: "Top Sites", comment: "Accessibility label for the button, displayed in the menu, used to open the Top Sites home panel.")
    static let TopSitesTitleString = NSLocalizedString("Menu.OpenTopSitesAction.AccessibilityLabel", tableName: "Menu", value: "最常造访", comment: "Accessibility label for the button, displayed in the menu, used to open the Top Sites home panel.")
//    static let BookmarksTitleString = NSLocalizedString("Menu.OpenBookmarksAction.AccessibilityLabel", tableName: "Menu", value: "Bookmarks", comment: "Accessibility label for the button, displayed in the menu, used to open the Bbookmarks home panel.")
    static let BookmarksTitleString = NSLocalizedString("Menu.OpenBookmarksAction.AccessibilityLabel", tableName: "Menu", value: "书签", comment: "Accessibility label for the button, displayed in the menu, used to open the Bbookmarks home panel.")
//    static let HistoryTitleString = NSLocalizedString("Menu.OpenHistoryAction.AccessibilityLabel", tableName: "Menu", value: "History", comment: "Accessibility label for the button, displayed in the menu, used to open the History home panel.")
    static let HistoryTitleString = NSLocalizedString("Menu.OpenHistoryAction.AccessibilityLabel", tableName: "Menu", value: "历史", comment: "Accessibility label for the button, displayed in the menu, used to open the History home panel.")
//    static let ReadingListTitleString = NSLocalizedString("Menu.OpenReadingListAction.AccessibilityLabel", tableName: "Menu", value: "Reading List", comment: "Accessibility label for the button, displayed in the menu, used to open the Reading list home panel.")
    static let ReadingListTitleString = NSLocalizedString("Menu.OpenReadingListAction.AccessibilityLabel", tableName: "Menu", value: "阅读清单", comment: "Accessibility label for the button, displayed in the menu, used to open the Reading list home panel.")
    ...
    static let MenuButtonReloadAuthString = NSLocalizedString( "Menu.OpenAuthenticationPageAction.Reload", tableName: "Menu", value: "恢复认证", comment: "Go to the page to reload the authentication." );
    // FULL SCREEN
}
